...
const Section2: FC = () => {
  return (
    <div className="w-[83%] mx-auto">
      <div className="w-full px-4 justify-between flex items-start md:px-0">
        {/* Heading */}
        <div className="w-[40%] mt-[30px] ">
            <p className='text-3xl md:text-4xl font-bold text-gray-700'>Почему фрилансеры выбирают <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-blue-600">Freelansy</span> для выполнения заказов?</p>
        </div>
        {/* Cards Grid */}
        <div className="w-full md:w-[55%] flex gap-3 flex-wrap">
          {/* Convenience Card */}
          <FeatureCard
...
const FeatureCard: FC<FeatureCardProps> = ({ icon, title, description, bgColor }) => (
  <div className="bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-shadow border border-gray-100 hover:border-purple-100 flex-1 min-w-[250px]">
    <div
