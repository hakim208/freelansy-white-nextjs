            ...
            <LayoutWrapper>
                ...
                <div className='flex items-start md:flex-row flex-col '>
                    <div className='flex flex-col items-center gap-[30px] h-[100vh] bg-blue-400 p-[50px_0px] md:w-[50%] w-full '>
                        ...
                        <Link href="/register">
                            <InteractiveHoverButton className=' w-[350px] '>Sigin Up</InteractiveHoverButton>
                        </Link>
                    </div>
                    <div className='md:w-[50%] w-full p-[50px_0px] '>
                        <div className='md:w-[70%] w-full m-auto flex flex-col items-start gap-[40px] '>
                            <div className='flex items-center gap-[10px] '>
                                ...
                                <Image src={Imgcongrats} width={0} height={0} alt='photo' />
                            </div>
                            <Link href="/">
                                    ...
                                    <CardContent>
                                        <form className="space-y-4">
                                            <div className='flex flex-col items-start gap-[10px]'>
                                                ...
                                                <Input value={name} onChange={(e) => setName(e.target.value)} id="text" type="text" className='p-[25px_7px]' placeholder="Имя пользователя" />
                                            </div>
                                            <div className='flex flex-col items-start gap-[10px]'>
                                                <Label htmlFor="password">Пароль</Label>
                                                <Input value={password} onChange={(e) => setPassword(e.target.value)} id="password" className='p-[25px_7px]' placeholder='Пароль пользователя' type="password" />
                                            </div>
                                            <div>
                                                <Link href="/register">
                                            ...
                                            <Button onClick={loginUser} type="button" variant="destructive" className="w-full">
                                                Войти
                                            </Button>
                                        </form>
                                    </CardContent>
